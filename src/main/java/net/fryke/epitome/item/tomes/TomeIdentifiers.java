...
public class TomeIdentifiers {
    ...
    public static final Identifier WATER_TOME = new Identifier(EpiTomeMod.MOD_ID, "water_tome");
    public static final Identifier AIR_TOME = new Identifier(EpiTomeMod.MOD_ID, "air_tome");
}
