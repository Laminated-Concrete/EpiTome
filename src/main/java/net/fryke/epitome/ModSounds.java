...
public class ModSounds {
    ...
    // ========== T1 Casting Sounds =============
    public static final Identifier STARTED_CASTING_T1_ID = new Identifier(EpiTomeMod.MOD_ID, "started_casting_t1");
    public static SoundEvent STARTED_CASTING_T1_EVENT = SoundEvent.of(STARTED_CASTING_T1_ID);

    public static final Identifier CASTING_LOOP_T1_ID = new Identifier(EpiTomeMod.MOD_ID, "casting_loop_t1");
    public static SoundEvent CASTING_LOOP_T1_EVENT = SoundEvent.of(CASTING_LOOP_T1_ID);

    public static final Identifier READY_TO_CAST_T1_ID = new Identifier(EpiTomeMod.MOD_ID, "ready_to_cast_t1");
    public static SoundEvent READY_TO_CAST_T1_EVENT = SoundEvent.of(READY_TO_CAST_T1_ID);

    public static final Identifier FINISHED_CASTING_T1_ID = new Identifier(EpiTomeMod.MOD_ID, "finished_casting_t1");
    public static SoundEvent FINISHED_CASTING_T1_EVENT = SoundEvent.of(FINISHED_CASTING_T1_ID);
    ...
    public static void registerModSoundEvents() {
        ...
        Registry.register(Registries.SOUND_EVENT, STARTED_CASTING_T1_ID, STARTED_CASTING_T1_EVENT);
        Registry.register(Registries.SOUND_EVENT, CASTING_LOOP_T1_ID, CASTING_LOOP_T1_EVENT);
        Registry.register(Registries.SOUND_EVENT, READY_TO_CAST_T1_ID, READY_TO_CAST_T1_EVENT);
        Registry.register(Registries.SOUND_EVENT, FINISHED_CASTING_T1_ID, FINISHED_CASTING_T1_EVENT);
    }
}
